...
const RoyalButton = forwardRef<HTMLButtonElement, RoyalButtonProps>(
  ({ variant = "primary", size = "md", children, className = "", ...props }, ref) => {
    ...
    // Primary: Solid gold ingot | Secondary: Dark espresso with gold accents
    const variantStyles = isPrimary
      ? `bg-gradient-to-br from-[#D4AF37] via-[#C9A227] to-[#AA8A2D] text-[#F8F5E4]
      ...
      : `bg-gradient-to-br from-[#3E2723] via-[#2C1A12] to-[#1A0F0A] text-[#D4AF37] border border-[#D4AF37]/40
