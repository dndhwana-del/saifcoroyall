...
const RoyalButton = forwardRef<HTMLButtonElement, RoyalButtonProps>(({
  ...
  return <motion.button ref={ref as React.Ref<HTMLButtonElement>} className={`${baseStyles} ${sizes[size]} ${className}`} style={{
    ...
    setIsHovered(false);
    setIsPressed(false);
  }} onMouseDown={() => setIsPressed(true)} onMouseUp={() => setIsPressed(false)} {...safeProps}>
      ...
      x: isHovered || sheenActive ? "150%" : "-150%"
    }} transition={{
      duration: 0.8,
      ease: "easeOut"
    }} />
      ...
      duration: 0.2
        ...
        <span className="relative z-10 font-serif" style={{
