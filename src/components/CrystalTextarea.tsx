...
interface CrystalTextareaProps extends React.TextareaHTMLAttributes<HTMLTextAreaElement> {
  label?: string;
  error?: string;
}

const CrystalTextarea = forwardRef<HTMLTextAreaElement, CrystalTextareaProps>(
        ...
        <div className="relative group">
          ...
          >
            ...
            <textarea
              ...
              onBlur={handleBlur}
              className={cn(
                "relative z-10 w-full px-4 py-4 bg-transparent min-h-[120px] resize-none",
...
export default CrystalTextarea;
